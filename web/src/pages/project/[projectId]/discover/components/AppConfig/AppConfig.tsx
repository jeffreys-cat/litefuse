...
import { Field, FieldSet } from "components/ui/form";
import { Input } from "components/ui/input";
import { SecretInput } from "components/ui/password-input";
import { useDiscoverStyles, type DiscoverTheme } from "components/ui/theme";
...
const AppConfig = ({ plugin }: AppConfigProps) => {
  const s = useDiscoverStyles(getStyles);
...
const getStyles = (theme: DiscoverTheme) => ({
  colorWeak: css`
